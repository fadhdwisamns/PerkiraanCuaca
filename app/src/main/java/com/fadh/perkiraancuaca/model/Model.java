...
public class Model implements Serializable, Parcelable
{
    ...
    ;
    private final static long serialVersionUID = 888254281659044293L;
     ...
     * @param wind
     */
    public Model(Coord coord, List<Weather> weather, String base, Main main, Integer visibility, Wind wind, Clouds clouds, Integer dt, Sys sys, Integer timezone, Integer id, String name, Integer cod) {
        super();
        this.coord = coord;
